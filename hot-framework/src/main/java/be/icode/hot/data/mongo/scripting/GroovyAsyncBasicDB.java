...
import be.icode.hot.data.scripting.GroovyAsyncDB;
...
public class GroovyAsyncBasicDB extends GroovyAsyncDB {
	...
	@Override
	protected GroovyAsyncBasicCollection buildAsyncCollection(be.icode.hot.data.Collection<Map<String, Object>> collection) {
