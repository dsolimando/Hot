...
public class DBFactory {
	...
	public DB<Map<String, Object>> buildGroovyDB() {
		return new be.icode.hot.data.jdbc.groovy.DB(queryBuilder, dataSource, schema);
	}
	
	public DB<NativeObject> buildJsDB() {
		return new be.icode.hot.data.jdbc.js.DB(queryBuilder, dataSource, schema);
	}
	
	public DB<PyDictionary> buildPyDB() {
		return new be.icode.hot.data.jdbc.python.DB(queryBuilder, dataSource, schema);
	}
