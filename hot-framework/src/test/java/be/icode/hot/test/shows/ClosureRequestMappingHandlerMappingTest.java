...
import be.icode.hot.spring.config.ThreadPoolsConfig.EventLoopFactory;
import be.icode.hot.test.shows.ClosureRequestMappingHandlerMappingTest.Config;
...
public class ClosureRequestMappingHandlerMappingTest {
	...
	public void testResolver() throws Exception {
		...
		HttpRequest httpRequest = new HttpRequest(new URL("http://hot.icode.be:8080/app/repository/items"), "application/json", "GET", headers, "/repository");
	...
	public void testResolver2() throws Exception {
		...
		headers.put("Accept",new Vector<>(Arrays.asList("text/html","application/xhtml+xml","application/xml;q=0.9,*/*;q=0.8")).elements());
		headers.put("Accept-Charset", new Vector<>(Arrays.asList("ISO-8859-1","utf-8;q=0.7,*;q=0.7")).elements());
		HttpRequest httpRequest = new HttpRequest(new URL("http://hot.icode.be:8080/app/repository/items"), "application/x-www-form-urlencoded", "GET", headers, "/repository");
