...
public class TestJsCollectionAPI {
	...
	public void testSync() throws Exception {
		...
		Script<org.mozilla.javascript.Script> script = new Script<>(IOUtils.toByteArray(getClass().getResourceAsStream("/be/icode/hot/test/data/jdbc/scripts/db.js")), "db.js");
