...
import be.solidx.hot.web.TranspiledScriptsController
...
class TestStaticResources {
	...
	public void testConcat() {
		...
		URL url = new URL("http://localhost/theapp/concat/be/solidx/hot/test/mvc/f1.js,be/solidx/hot/test/mvc/f2.js,be/solidx/hot/test/mvc/f3.js,be/solidx/hot/test/mvc/f4.js,be/solidx/hot/test/mvc/f5.js")
...
;function f5() {
	...
	void testLessResource() {
		...
		URL url = new URL("http://localhost/theapp/be/solidx/hot/test/mvc/style.less")
		HttpServletRequest request = new HttpRequest(url, null, "GET", null, "")
...
#header .logo {
  width: 300px;
	...
	void testCoffeeResource() {
		...
		URL url = new URL("http://localhost/theapp/be/solidx/hot/test/mvc/main.coffee")
		HttpServletRequest request = new HttpRequest(url, null, "GET", null, "")
