...
$qt("testFindWhere1", function(assert) {
	var promise = adb.getCollection("owners").find({id:6}).promise()
	
	promise.done(function(l) {
...
$qt("testFindWhere2", function(assert) {
	var promise = adb.getCollection("owners").find({id:6,first_name:"Jean"}).promise()
...
$qt("testFindWhere3", function(assert) {
	var promise = adb.getCollection("owners").find({id:6,first_name:"Carlos"}).promise()
	promise.done(function(l) {
...
$qt("testFindWhere4", function(assert) {
	var promise = adb.getCollection("owners").find({$or:[
	                                  				{first_name:"Carlos"},
	                                				{first_name:"George"}
												]}).promise();
	promise.done(function(l) {
...
$qt("testFindWhere8", function(assert) {
	var promise = adb.getCollection("owners").find({first_name:{$in:["George", "Jean", "Carlos"]}}).promise()
...
$qt("testFindWhere9", function(assert) {
	var promise = adb.getCollection("owners").find({first_name:{$nin:["George", "Jean", "Carlos"]}}).promise()
...
$qt("testFindWhere10", function(assert) {
	var promise = adb.getCollection("owners")
