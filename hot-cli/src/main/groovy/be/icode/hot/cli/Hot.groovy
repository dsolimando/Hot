...
public class Hot {
	...
	def startJetty = { project, port ->
		...
		websocketHolder.initParameters["contextConfigLocation"] = "be.icode.hot.spring.config.WebSocketConfig"
		...
		if (project.datastore) {
			...
			datastoreHolder.initParameters["contextConfigLocation"] = "be.icode.hot.spring.config.DataStoreConfig"
